...
import esprit.CatchTalent.candidatservice.security.jwt.JwtUtils;
import esprit.CatchTalent.candidatservice.security.request.LoginRequest;
...
import esprit.CatchTalent.candidatservice.security.response.UserInfoResponse;
import esprit.CatchTalent.candidatservice.security.services.UserDetailsImpl;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "com":
                        Role comRole = roleRepository.findByName(ERole.COMMERCIAL)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(comRole);
